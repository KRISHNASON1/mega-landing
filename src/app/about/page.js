            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-0 relative max-w-6xl mx-auto">
              {[
                ...
                return (
                  ...
                  >
                    {/* Icon circle */}
                    <div className="w-12 h-12 rounded-full bg-blue-100 border-4 border-white shadow-sm flex items-center justify-center mb-4 relative z-10 transition-transform duration-300 hover:scale-110 hover:rotate-3">
                    ...
                    >
                      <div className="text-4xl md:text-5xl font-bold text-blue-500 text-center mb-4 group-hover:scale-105 transition-transform duration-300">
                        {stat.value}
                      </div>

                      {/* Slider Dot on the bottom */}
                      <div className="w-full h-1.5 bg-blue-100 rounded-full mt-1 relative overflow-hidden">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-full bg-blue-500 rounded-full group-hover:w-full transition-all duration-500 ease-out" />
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-white border-2 border-blue-500 rounded-full shadow-sm group-hover:scale-110 transition-transform duration-300" />
                      </div>
                    </div>
