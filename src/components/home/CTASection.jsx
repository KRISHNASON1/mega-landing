        ...
        <div className="text-center">
          <div className="mx-auto max-w-4xl p-12 rounded-[32px] backdrop-blur-md bg-white/10 border border-white/20 shadow-2xl">
              ...
              <p className="text-xl text-white/90 mb-10 max-w-2xl mx-auto">
                Get instant quotes, expert consultation, and seamless delivery for all your industrial material needs.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                <a
                  href="/contact"
                  className="group px-8 py-4 bg-white text-primary-700 rounded-full font-semibold text-lg shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center space-x-2"
                >
                ...
                <a
                  href="https://wa.me/917506070157"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-8 py-4 border-2 border-white text-white rounded-full font-semibold text-lg hover:bg-white hover:text-primary-700 transition-all duration-300 flex items-center space-x-2"
                >
